        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 mb-8">
            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
              ...
              <div className="flex flex-wrap gap-3 items-center">
                ...
                <div className="flex items-center space-x-1 bg-gray-100 rounded-lg p-1">
                  <span className="text-xs text-gray-600 px-2">Grid:</span>
                  <button
                    onClick={() => setGridColumns(1)}
                    className={`p-2 rounded transition-colors ${
                      gridColumns === 1 ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                    }`}
                    title="1 column"
                  >
                  ...
                  <button
                    ...
                    className={`p-2 rounded transition-colors ${
                      gridColumns === 2 ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                    }`}
                    title="2 columns"
                  >
                  ...
                  <button
                    ...
                    className={`p-2 rounded transition-colors ${
                      gridColumns === 3 ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                    }`}
                    title="3 columns"
                  >
                  ...
                  <button
                    ...
                    className={`p-2 rounded transition-colors ${
                      gridColumns === 4 ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                    }`}
                    title="4 columns"
                  >
            ...
            <div className="mt-4 flex justify-between items-center text-sm text-gray-600">
              ...
              <span>Page {currentPage} of {totalPages} • {gridColumns} column{gridColumns !== 1 ? 's' : ''}</span>
            </div>
          </div>
